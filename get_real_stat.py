...
# python get_real_stat.py --dataroot database/edges2shoes-r --output_path real_stat/edges2shoes-r_B.npz
# python get_real_stat.py --dataroot database/maps --output_path real_stat/maps_A.npz --direction BtoA
# python get_real_stat.py --dataroot database/maps --output_path real_stat/maps_B.npz 
