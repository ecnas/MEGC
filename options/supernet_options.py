...
class SupernetOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # Evolution params
        parser.add_argument('--evolution_epoch_freq', type=int, default=5,
                            help='frequency of evolution at the end of epoch')
        parser.add_argument('--warmup_epochs', type=int, default=50, help='the number of warm up epochs')
        parser.add_argument('--population_size', type=int, default=20, help='the size of populations')
        parser.add_argument('--eval_loss', action='store_true', help='evaluating model loss or visual quality')
        parser.add_argument('--gen_num', type=int, default=30, help='Number of generations to evolution during supernet training')
        parser.add_argument('--p_crossover', type=float, default=1, help='probability of crossover operator')
        parser.add_argument('--p_mutation', type=float, default=0.5, help='probability of mutation operator')
        parser.add_argument('--eval_cnt', type=int, default=1, help='number of evaluation samples')
