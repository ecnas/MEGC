...
class Trainer:
    def __init__(self, task):
        ...
        elif task == 'supernet' or task == 'supernet_emo':
        ...
        if task == 'supernet' or task == 'supernet_emo':
            opt.train_iters_one_epoch = dataset_size
    ...
    def start(self):
        ...
        for epoch in epoch_tqdm:            
            ...
            if self.task == 'supernet_emo':
                model.evolution(epoch)
